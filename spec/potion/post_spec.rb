  ...
  describe '#==' do
    context "when the two Posts are identical" do
      it "should return true" do
        post1 = Post.new(@fixture_path + "/test-site/blog/_posts/2013-03-04-a-new-thing/a-new-thing.html.haml", @site)
        post2 = Post.new(@fixture_path + "/test-site/blog/_posts/2013-03-04-a-new-thing/a-new-thing.html.haml", @site)
        post1.should == post2
      end
    end
    ...
    context "when the two Posts are different" do
      it "should return false" do
        post1 = Post.new(@fixture_path + "/test-site/blog/_posts/2013-03-04-a-new-thing/a-new-thing.html.haml", @site)
        post2 = Post.new(@fixture_path + "/test-site/portfolio/_posts/a-cool-thing/a-cool-thing.html.haml", @site)
